...
export default function SignInPage() {
  ...
  async function handleGoogleSignIn() {
    // In real app, use NextAuth with Google provider
  ...
  return (
    <div className="max-w-md mx-auto mt-16">
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <p className="text-gray-600 text-center mb-6">Sign in to your BookItzzz account</p>
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          ...
          <p className="text-xs text-blue-700">Member: member0@example.com / password123</p>
        </div>
      </div>
    </div>
  );
